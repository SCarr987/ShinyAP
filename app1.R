...
ui <- fluidPage(
   ...
   sidebarLayout(
      sidebarPanel(
         ...
         h4 ("Old Faithful ap Showing Times Between Geyer Eruptions"),
         h5("How to use:"),
         p("* Select the slider to change the number of histogram bins"),
         p("* Choose colors from the dropdown"),
         p("* Find the mean, 95% confidence interval, and/or interquartile range using checkboxes"),
         p("Use the tabs for more information")
